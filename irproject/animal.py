...
""" 你的 APPID AK SK """
APP_ID = '33531320'
API_KEY = 'bAWbvP8f7aPV0T2mD5XoVBOg'
SECRET_KEY = 'QT5gAd0ghS6AVpvYHV0UG0xbA1WHj0sH'
...
# 添加标题标签
title_label = tk.Label(window, text="欢迎进入动物识别系统", font=("宋体", 32, "bold"), bg="#00BFFF", fg="#FFFFFF")
