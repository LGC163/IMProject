...
""" 你的 APPID AK SK """
APP_ID = '33570145'
API_KEY = 'VYPcmrb21T2lH3r8qgjF2YGs'
SECRET_KEY = 'hRtRgGkGoxclo7qZnHGYdAG1pYzPULgi'
...
# 添加标题标签
title_label = tk.Label(window, text="欢迎进入果蔬识别系统", font=("宋体", 32, "bold"), bg="#00BFFF", fg="#FFFFFF")
